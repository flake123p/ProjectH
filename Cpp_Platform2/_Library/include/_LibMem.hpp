...
#define MEM_CONFIG(addr,len,key,flag) LibMem_ConfigureProtection(addr,len,key,flag)
#define MEM_DUMP()                    LibMem_Dump()
#define MEM_DUMP_CELL(addr)           LibMem_DumpCell(addr)
//void * memset ( void * ptr, int value, size_t num );
#define MEM_SET(ptr,val,num)      LIB_MEM_WRITE_CHECK(ptr,num,0,1);memset(ptr,val,num)
#define MEM_SETK(key,ptr,val,num) LIB_MEM_WRITE_CHECK(ptr,num,key,1);memset(ptr,val,num)
//void * memcpy ( void * destination, const void * source, size_t num );
#define MEM_CPY(dst,src,num)       LIB_MEM_WRITE_CHECK(dst,num,0,1);memcpy(dst,src,num)
#define MEM_CPYK(key,dst,src,num)  LIB_MEM_WRITE_CHECK(dst,num,key,1);memcpy(dst,src,num)
#define MEM_CPYB(dst,src,num)      LIB_MEM_WRITE_CHECK(dst,num,0,1);LIB_MEM_READ_CHECK(&(src),sizeof(src),0);memcpy(dst,src,num)
#define MEM_CPYKB(key,dst,src,num) LIB_MEM_WRITE_CHECK(dst,num,key,1);LIB_MEM_READ_CHECK(&(src),sizeof(src),key);memcpy(dst,src,num)
...
#define MEM_CONFIG(addr,len,key,flag)
#define MEM_DUMP()
#define MEM_DUMP_CELL(addr)
//void * memset ( void * ptr, int value, size_t num );
#define MEM_SET(ptr,val,num)       memset(ptr,val,num)
#define MEM_SETK(key,ptr,val,num)  memset(ptr,val,num)
//void * memcpy ( void * destination, const void * source, size_t num );
#define MEM_CPY(dst,src,num)       memcpy(dst,src,num)
#define MEM_CPYK(key,dst,src,num)  memcpy(dst,src,num)
#define MEM_CPYB(dst,src,num)      memcpy(dst,src,num)
#define MEM_CPYKB(key,dst,src,num) memcpy(dst,src,num)
